       ...
       <iso-standard xmlns="http://riboseinc.com/isoxml" type="presentation">
          ...
          <sections>
             <clause id="A" displayorder="3">
                <title id="_">
                   BB
                   <fn reference="1" original-reference="45" id="_" target="_">
       ...
       <iso-standard xmlns="http://riboseinc.com/isoxml" type="presentation">
          ...
          <sections>
             <clause id="A" displayorder="4">
                <title id="_">
                   BB
                   <fn reference="6" original-reference="45" id="_" target="_">
                      <p original-id="_">Fourth footnote.</p>
                      <fmt-fn-label>
                         <sup>
                ...
                <clause id="AA">
                   ...
                   <p>
                      A.
                      <fn reference="7" original-reference="42" id="_" target="_">
                         <p original-id="_">Third footnote.</p>
                         <fmt-fn-label>
                            <sup>
       ...
       <body lang="EN-US" link="blue" vlink="#954F72" xml:lang="EN-US" class="container">
          ...
          <div class="main-section">
             ...
             <div id="F">
                ...
                <p>
                   C.
                   <a class="FootnoteRef" href="#fn:_50">
                      <sup>4)</sup>
                   </a>
                </p>
             </div>
             ...
             <aside id="fn:_50" class="footnote">
                <p id="_">Hello! denoted as 15 % (m/m).</p>
             </aside>
