...
RSpec.describe IsoDoc::Bipm do
    ...
    output = <<~OUTPUT
      <body lang="EN-US" link="blue" vlink="#954F72" xml:lang="EN-US" class="container">
         ...
         <div class="main-section">
            ...
            <div id="H">
               <h1>2<span class="fmt-clause-delim">.</span>  Terms, Definitions, Symbols and Abbreviated Terms</h1>
               <div id="I">
                  <h2>2.1<span class="fmt-clause-delim">.</span>  Normal Terms</h2>
                  <p class="TermNum" id="J">2.1.1<span class="fmt-clause-delim">.</span></p>
                  <p class="Terms" style="text-align:left;">
                     <b><dfn>Term2</dfn></b>
                  </p>
               </div>
               <div id="D">
                  <h2>2.2<span class="fmt-clause-delim">.</span>  Scope</h2>
                  <p id="E">Text</p>
               </div>
               <div id="K">
                  <h2>2.3<span class="fmt-clause-delim">.</span>  Symbols</h2>
                  <div class="figdl">
                     <dl>
                        <dt>
                           <p>Symbol</p>
            ...
            <div id="L" class="Symbols">
               <h1>3<span class="fmt-clause-delim">.</span>  Symbols</h1>
               <div class="figdl">
                  <dl>
                     <dt>
                        <p>Symbol</p>
            ...
            <div id="M">
               <h1>4<span class="fmt-clause-delim">.</span>  Clause 4</h1>
               <div id="N">
                  <h2>4.1<span class="fmt-clause-delim">.</span>  Introduction</h2>
               </div>
               <div id="O">
                  <h2>4.2<span class="fmt-clause-delim">.</span>  Clause 4.2</h2>
               </div>
            </div>
            <div>
               <h1>5<span class="fmt-clause-delim">.</span>  Normative References</h1>
            </div>
            <br/>
            <div id="P" class="Section3">
               ...
               <div id="Q">
                  <h2>A1.1<span class="fmt-clause-delim">.</span>  Annex A.1</h2>
                  <div id="Q1">
                     <h3>A1.1.1<span class="fmt-clause-delim">.</span>  Annex A.1a</h3>
                  </div>

               </div>         <div id="Q2">
           <h2>Appendix 1<span class="fmt-clause-delim">.</span>  An Appendix</h2>
        </div>
            </div>
            <br/>
            <div id="QQ" class="Section3">
               ...
               <div id="QQ1">
                  <p class="TermNum" id="term-term-1">A2.1<span class="fmt-clause-delim">.</span></p>
                  <p class="Terms" style="text-align:left;">
                     <b><dfn>Term</dfn></b>
                  </p>
               </div>
      ...
      <body lang="EN-US" link="blue" vlink="#954F72" xml:lang="EN-US" class="container">
         ...
         <div class="main-section">
            ...
            <div class="Section3" id="B">
               <h1 class="IntroTitle">Introduction</h1>
               <div id="C">
                  <h2>0.1<span class="fmt-clause-delim">.</span>  Introduction Subsection</h2>
               </div>
            </div>
            <p class="zzSTDTitle1">
               <span class="boldtitle">Main Title</span>
            ...
            <div id="H">
               ...
               <div id="D">
                  <h2>3.2<span class="fmt-clause-delim">.</span>  Scope</h2>
                  <p id="E">Text</p>
               </div>
               <div id="K">
                  <h2>3.3<span class="fmt-clause-delim">.</span>  Symbols</h2>
                  <div class="figdl">
                     <dl>
                        <dt>
                           <p>Symbol</p>
            ...
            <div id="L" class="Symbols">
               <h1>4<span class="fmt-clause-delim">.</span>  Symbols</h1>
               <div class="figdl">
                  <dl>
                     <dt>
                        <p>Symbol</p>
         ...
         <div id="QQ1">
            <p class="TermNum" id="term-term-1">B.1<span class="fmt-clause-delim">.</span></p>
            <p class="Terms" style="text-align:left;">
               <b><dfn>Term</dfn></b>
            </p>
         </div>
  ...
  it "processes appendix names in appendix document" do
    ...
    pres_output =
      strip_guid(IsoDoc::Bipm::PresentationXMLConvert.new(presxml_options)
      .convert("test", input, true)
      .gsub(%r{<localized-strings>.*</localized-strings>}m, ""))
    expect(pres_output).to be_xml_equivalent_to output
  ...
  it "processes unnumbered sections" do
    ...
    output = <<~OUTPUT
      <bipm-standard xmlns="http://riboseinc.com/isoxml" type="presentation">
         ...
         <annex id="A1" obligation="normative" unnumbered="true" displayorder="6">
            ...
            <variant-title type="toc">
               <semx element="title" source="_">Alpha</semx>
            </variant-title>
         ...
         <annex id="A2" obligation="normative" autonum="1" displayorder="5">
            ...
            <variant-title type="toc">
               ...
               <semx element="title" source="_">Gamma</semx>
            </variant-title>
            <clause id="B2" unnumbered="true">
               <title id="_">Delta</title>
               <fmt-title depth="2" id="_">
    ...
    OUTPUT
    expect(strip_guid(IsoDoc::Bipm::PresentationXMLConvert
          .new(presxml_options)
      .convert("test", input, true)))
      .to be_xml_equivalent_to output
  end
