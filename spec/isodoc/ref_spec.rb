...
<bibitem id="ref12">
  ...
  <docidentifier type="IETF">RFC 20</docidentifier>
    ...
    OUTPUT
    expect(xmlpp(IsoDoc::BIPM::PresentationXMLConvert.new({}).convert("test", input, true).sub(%r{<localized-strings>.*</localized-strings>}m, ""))).to be_equivalent_to xmlpp(presxml)
    expect(xmlpp(IsoDoc::BIPM::HtmlConvert.new({}).convert("test", presxml, true).gsub(%r{^.*<body}m, '<body').
