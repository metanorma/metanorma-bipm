<?xml version="1.0" encoding="UTF-8"?><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:fo="http://www.w3.org/1999/XSL/Format" xmlns:mn="https://www.metanorma.org/ns/standoc" xmlns:mnx="https://www.metanorma.org/ns/xslt" xmlns:mathml="http://www.w3.org/1998/Math/MathML" xmlns:xalan="http://xml.apache.org/xalan" xmlns:fox="http://xmlgraphics.apache.org/fop/extensions" xmlns:pdf="http://xmlgraphics.apache.org/fop/extensions/pdf" xmlns:java="http://xml.apache.org/xalan/java" xmlns:redirect="http://xml.apache.org/xalan/redirect" exclude-result-prefixes="java" extension-element-prefixes="redirect" version="1.0">
	...
	<xsl:template match="mn:li/mn:fmt-name" priority="3" mode="update_xml_step1">
		<xsl:choose>
			...
			<xsl:when test="ancestor::*[mn:preface] and ancestor::mn:clause[not(@type = 'toc')]"/>
			<xsl:otherwise>
	...
	<xsl:template match="mn:clause/*   [not(self::mn:quote)]   [following-sibling::*    [not(self::mn:quote)]    [1][self::mn:note]]" mode="flatxml"> <!-- find element, which has next 'note' -->
		<xsl:copy>
			<xsl:apply-templates select="@*|node()" mode="flatxml"/>
	...
	<xsl:template name="setListItemLabel">
		...
		<xsl:choose>
			<xsl:when test="parent::mn:ul and ../ancestor::mn:ul"/> <!-- &#x2014; dash -->
	...
	<xsl:template match="mn:li" priority="2">
		...
		<xsl:if test="not(following-sibling::*[1][self::mn:li]) and          not(../ancestor::mn:ul | ../ancestor::mn:ol) and not (../following-sibling::*[1][self::mn:ul or self::mn:ol])">
			<fo:block/>
		</xsl:if>
